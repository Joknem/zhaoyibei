...
#define SSD1306_SETDISPLAY_OFFSET 0xD3  //two byte command, must write offset after send this command
#define SSD1306_SETCLOCK_DIVIDE_RATIO 0xD5 //Set the divide ratio to generate DCLK (Display Clock) from CLK
#define SSD1306_SET_PRECHARGE_PERIOD 0xD9 //This command is used to set the duration of the pre-charge period.
#define SSD1306_SET_COM_CONFIG 0xDA //This command sets the COM signals pin configuration to match the OLED panel hardware layout.
#define SSD1306_SET_DESELECT 0xDB //This command adjusts the V COMH regulator output.
