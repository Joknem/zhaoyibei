...
int Sensors_I2C_WriteRegister(unsigned char slave_addr, unsigned char reg_addr,
  ...
  if (HAL_I2C_Mem_Write(&hi2c1, slave_addr, reg_addr, I2C_MEMADD_SIZE_8BIT,
                        (uint8_t *)data_ptr, len, 1000) != HAL_OK) {
...
int Sensors_I2C_ReadRegister(unsigned char slave_addr, unsigned char reg_addr,
  ...
  if (HAL_I2C_Mem_Read(&hi2c1, slave_addr, reg_addr, I2C_MEMADD_SIZE_8BIT,
                       (uint8_t *)data_ptr, len, 1000) != HAL_OK) {
...
static int setup_compass(void) {
  ...
  for (akm_addr = 0x18; akm_addr <= 0x19; akm_addr++) {
    int result;
