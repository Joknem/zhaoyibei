#!/bin/bash
##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.1.0] date: [Thu Apr 25 19:33:05 CST 2024] 
##########################################################################################################################
...
programmer := /Applications/STM32Programmer/STM32CubeProgrammer.app/Contents/MacOs/bin/STM32_Programmer_CLI 
#######################################
# clean up
#######################################
clean:
...
install:
	$(programmer) -c port=SWD freq=24000 sn=003500393432511230343838 mode=UR reset=HWrst -w ./build/g474_test.bin 0x08000000
echo:
	@echo $(C_INCLUDES)
#######################################
# dependencies
